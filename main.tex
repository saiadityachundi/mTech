...
In this work, we present a novel communication architecture for UAV swarms, which combines both the above said, long range and short range communication aspects. Moreover, our communication architecture is based on Robot Operating System(ROS), which ensures that any distributed application can be easily integrated into, and extended by the capabilities of ROS.
}
